...
static Keyword aKeywordTable[] = {
  ...
  {"RA_EXCEPT",   "TK_RA_EXCEPT",   RALITE_KEY_WORD, 1},

  {"RA_RENAME",    "TK_RA_RENAME",   RALITE_KEY_WORD, 1},

  {"RA_INTERSECT",    "TK_RA_INTERSECT",   RALITE_KEY_WORD, 1},

{"RA_INNER_JOIN",    "TK_RA_INNER_JOIN",   RALITE_KEY_WORD, 1}, //笛卡尔积
{"RA_NATURAL_JOIN",    "TK_RA_NATURAL_JOIN",   RALITE_KEY_WORD, 1},
{"RA_SITA_JOIN",    "TK_RA_SITA_JOIN",   RALITE_KEY_WORD, 1},
{"RA_LEFT_JOIN",    "TK_RA_LEFT_JOIN",   RALITE_KEY_WORD, 1},
{"RA_RIGHT_JOIN",    "TK_RA_RIGHT_JOIN",   RALITE_KEY_WORD, 1},
{"RA_OUTER_JOIN",    "TK_RA_OUTER_JOIN",   RALITE_KEY_WORD, 1},

  {"RA_GROUP",    "TK_RA_GROUP",   RALITE_KEY_WORD, 1},
